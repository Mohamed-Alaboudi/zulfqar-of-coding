...
case "${output}" in
  *'zulfqar-trivy-cache:/root/.cache/trivy'*'aquasec/trivy:0.72.0@sha256:cffe3f5161a47a6823fbd23d985795b3ed72a4c806da4c4df16266c02accdd6f'*'fs'*'--scanners vuln,misconfig,license'*'.'*) ;;
  *)
