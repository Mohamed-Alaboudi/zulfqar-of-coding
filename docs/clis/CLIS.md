...
tools above — a Workspace CLI (Gmail/Calendar/Drive/Sheets automation), a
...
- **Workspace automation** → Google's own [Google Workspace APIs](https://developers.google.com/workspace) client libraries, or a maintained open-source Gmail/Calendar CLI if you want something off-the-shelf rather than hand-rolled.
